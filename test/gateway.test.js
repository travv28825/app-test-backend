        ...
        it('add a gateway with more than 10 devices', (done) => {
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    res.body.should.have.property('message').eql('A gateway can only have less than 10 or less devices!');
                    done();
                });
        });
    });
        ...
        it('UPDATE a nonexistent gateway given the serial number', (done) => {
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    res.body.response.should.have.property('ok').eql(1);
                    res.body.response.should.have.property('n').eql(0);
                    done();
                });
        });
    });
